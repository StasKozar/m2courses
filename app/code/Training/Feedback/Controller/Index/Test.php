...
class Test extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        // load item by id
        $feedback = $this->feedbackRepository->getById((int)$newFeedback->getId());
        $this->printFeedback($feedback);
        // update item
        $feedbackToUpdate = $this->feedbackRepository->getById((int)$newFeedback->getId());
        $feedbackToUpdate->setMessage('CUSTOM ' . $feedbackToUpdate->getMessage());
        // delete feedback
        $this->feedbackRepository->deleteById((int)$newFeedback->getId());
        // load multiple items
